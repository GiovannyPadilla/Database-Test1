...
namespace Test1.Controllers
{
    ...
    {
        private readonly Test1ContextSQLServer _context;

        public EstudiantesController(Test1ContextSQLServer context)
        {
            _context = context;
        }
        ...
        {
            var test1ContextSQLServer = _context.Estudiante.Include(e => e.Carrera);
            return View(await test1ContextSQLServer.ToListAsync());
        }
